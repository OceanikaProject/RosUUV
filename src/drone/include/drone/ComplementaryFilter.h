...
class ComplementaryFilter
{
    public:
        ...
        float getRoll()
        {
                ...
                return atan2(2.0*(q[0]*q[1] + q[2]*q[3]), q[0]*q[0] - q[1]*q[1] - q[2]*q[2] + q[3]*q[3]) * 57.29578f;
        }

        float getPitch()
        {
            // return asinf(-2.0f * (q[1]*q[3] - q[0]*q[2])) * 57.29578f;
            return -asin(-2.0f * (q[1]*q[3] - q[0]*q[2])) * 57.29578f;
        }

        float getYaw()
        {
            // return atan2f(q[1]*q[2] + q[0]*q[3], 0.5f - q[2]*q[2] - q[3]*q[3]) * 57.29578f;
            return atan2(2.0*q[1]*q[2] + q[0]*q[3], q[0]*q[0] + q[1]*q[1] - q[2]*q[2] - q[3]*q[3]) * 57.29578f;
        }
